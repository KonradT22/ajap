...
def main() -> None:
    ...
    parser.add_argument(
        "--ingest-boards",
        action="store_true",
        help="Ingest Greenhouse + Lever + Workday + Ashby boards with inline descriptions",
    )
    parser.add_argument(
        "--match",
        action="store_true",
    ...
    parser.add_argument(
        "--dry-run-boards",
        action="store_true",
        help="Fetch Greenhouse + Lever + Workday + Ashby boards, apply pre-filter, report net-new (no DB writes)",
    )
    parser.add_argument(
        "--limit",
        type=int,
